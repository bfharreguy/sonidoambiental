...
public class servidorhttp implements Runnable {
    ...
    private tareasprogramadas registrarmusic =tareasprogramadas.getInstance();
    ...
    private class RespuestaMensaje {
        ...
        public RespuestaMensaje(String mensaje, boolean error) {
            ...
            if (mensaje.startsWith("anular:") && mensaje.substring(7).length() > 1) {
               ...
               // System.out.println(mensaje.substring(7) + "anulado");
            }
            if (mensaje.startsWith("borrar:") && mensaje.substring(7).length() > 1) {
                ...
                logueo.borrarmusica(mensaje.substring(7));
                 //System.out.println(mensaje.substring(7) + "borrado");
            }
            switch (mensaje) {
            ...
            public void handle(final HttpExchange t) throws IOException {
                ...
                try {
                    ...
                    for (FileItem fi : result) {
                       ...
                       //registrarmusic.agregarmusica("registrarmusica", nombre);
                    }
